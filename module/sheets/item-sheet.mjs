 ...
 * @extends {ItemSheetV2}
 */
export class MofanItemSheet extends api.HandlebarsApplicationMixin(
  sheets.ItemSheetV2
) {
  constructor(options = {}) {
    super(options);
  ...
  static PARTS = {
    header: {
      template: 'systems/mofan-vtt/templates/item/header.hbs',
    },
    tabs: {
    ...
    description: {
      template: 'systems/mofan-vtt/templates/item/description.hbs',
    },
    attributesFeature: {
      template:
